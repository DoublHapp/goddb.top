...
真实平台视频必须同时登记平台、视频 ID、canonical 原视频 URL 和创作者署名。网站不抓取或重新托管平台视频；大体积本地视频不进入 Git/Vercel。随笔 Markdown 使用 marked 解析并由 DOMPurify 清洗，中文正文可在英文界面明确回退；学习存档通过免责声明标记可能过时或有误。完整商业游戏文件不属于可发布资源。
